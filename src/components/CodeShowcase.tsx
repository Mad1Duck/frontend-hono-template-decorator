...
const BASIC_CODE = (
  <>
    ...
    <span className="t-dec">@Injectable</span>([<span className="t-cls">UserService</span>]){'\n'}
    ...
    {'  '}<span className="t-kw">async</span> <span className="t-fn">create</span>(c: <span className="t-cls">Context</span>) {'{'}{'\n'}
    {'    '}<span className="t-kw">const</span> body = <span className="t-kw">await</span> <span className="t-fn">Body</span>(c, <span className="t-cls">CreateUserSchema</span>);{'\n'}
    ...
    {'  '}<span className="t-kw">async</span> <span className="t-fn">update</span>(c: <span className="t-cls">Context</span>) {'{'}{'\n'}
    {'    '}<span className="t-kw">const</span> id   = <span className="t-fn">Param</span>(c, <span className="t-str">'id'</span>);{'\n'}
    {'    '}<span className="t-kw">const</span> body = <span className="t-kw">await</span> <span className="t-fn">Body</span>(c, <span className="t-cls">UpdateUserSchema</span>);{'\n'}
    ...
    {'  '}<span className="t-fn">remove</span>(c: <span className="t-cls">Context</span>) {'{'}{'\n'}
    {'    '}<span className="t-kw">return</span> this.userService.<span className="t-fn">delete</span>(<span className="t-fn">Param</span>(c, <span className="t-str">'id'</span>));{'\n'}
    {'  '}{'}'}{'\n'}
    {'}'}{'\n\n'}
...
const AUTH_CODE = (
  <>
    ...
    {'  '}<span className="t-kw">async</span> <span className="t-fn">deleteUser</span>(c: <span className="t-cls">Context</span>) {'{'}{'\n'}
    {'    '}<span className="t-kw">return</span> this.userService.<span className="t-fn">delete</span>(<span className="t-fn">Param</span>(c, <span className="t-str">'id'</span>));{'\n'}
    {'  '}{'}'}{'\n\n'}
    ...
    {'  '}<span className="t-kw">async</span> <span className="t-fn">login</span>(c: <span className="t-cls">Context</span>) {'{'}{'\n'}
    {'    '}<span className="t-kw">const</span> dto = <span className="t-kw">await</span> <span className="t-fn">Body</span>(c, <span className="t-cls">LoginSchema</span>);{'\n'}
...
const DI_CODE = (
  <>
    <span className="t-kw">import</span> {'{ '}<span className="t-cls">Injectable</span>, <span className="t-cls">Singleton</span>, <span className="t-cls">RequestScoped</span>, <span className="t-cls">Controller</span>, <span className="t-cls">Get</span>, <span className="t-cls">Param</span>{' }'} <span className="t-kw">from</span> <span className="t-str">'hono-forge'</span>;{'\n'}
    <span className="t-kw">import type</span> {'{ '}<span className="t-cls">Context</span>, <span className="t-cls">OnInit</span>, <span className="t-cls">OnDestroy</span>{' }'} <span className="t-kw">from</span> <span className="t-str">'hono-forge'</span>;{'\n\n'}
    <span className="t-cmt">// Singleton: one instance for app lifecycle</span>{'\n'}
    <span className="t-dec">@Injectable</span>() <span className="t-dec">@Singleton</span>(){'\n'}
    <span className="t-kw">class</span> <span className="t-cls">CacheService</span> <span className="t-kw">implements</span> <span className="t-cls">OnInit</span>, <span className="t-cls">OnDestroy</span> {'{'}{'\n'}
    ...
    <span className="t-dec">@Injectable</span>([<span className="t-cls">CacheService</span>]) <span className="t-dec">@RequestScoped</span>(){'\n'}
    <span className="t-kw">class</span> <span className="t-cls">RequestContext</span> <span className="t-kw">implements</span> <span className="t-cls">OnDestroy</span> {'{'}{'\n'}
    {'  '}<span className="t-kw">constructor</span>(<span className="t-kw">private</span> cache: <span className="t-cls">CacheService</span>) {'{}'}{'\n'}
    {'  '}<span className="t-kw">readonly</span> traceId = crypto.<span className="t-fn">randomUUID</span>();{'\n'}
    {'  '}<span className="t-kw">async</span> <span className="t-fn">onDestroy</span>() {'{'} <span className="t-kw">await</span> this.cache.<span className="t-fn">cleanup</span>(this.traceId); {'}'}{'\n'}
    {'}'}{'\n\n'}
    <span className="t-dec">@Controller</span>(<span className="t-str">'/users'</span>){'\n'}
    <span className="t-dec">@Injectable</span>([<span className="t-cls">CacheService</span>, <span className="t-cls">RequestContext</span>]){'\n'}
    <span className="t-kw">class</span> <span className="t-cls">UserController</span> {'{'}{'\n'}
    ...
    {'  '}<span className="t-dec">@Get</span>(<span className="t-str">'/:id'</span>) <span className="t-fn">get</span>(c: <span className="t-cls">Context</span>) {'{'} <span className="t-kw">return</span> this.cache.<span className="t-fn">get</span>(<span className="t-fn">Param</span>(c, <span className="t-str">'id'</span>)); {'}'}{'\n'}
    {'}'}{'\n\n'}
    <span className="t-kw">const</span> app = <span className="t-kw">new</span> <span className="t-cls">Hono</span>();{'\n'}
    app.<span className="t-fn">route</span>(<span className="t-str">'/'</span>, <span className="t-cls">HonoRouteBuilder</span>.<span className="t-fn">build</span>(<span className="t-cls">UserController</span>));{'\n'}
    <span className="t-kw">export default</span> app;
...
const CRUD_CODE = (
  <>
    ...
    <span className="t-kw">import</span> {'{ '}<span className="t-fn">z</span>{' }'} <span className="t-kw">from</span> <span className="t-str">'zod'</span>;{'\n\n'}
    <span className="t-kw">const</span> <span className="t-cls">CreateUserSchema</span> = z.<span className="t-fn">object</span>({'{ '}name: z.<span className="t-fn">string</span>(), email: z.<span className="t-fn">string</span>(){' }'});{'\n\n'}
    <span className="t-dec">@Injectable</span>(){'\n'}
    <span className="t-kw">class</span> <span className="t-cls">UserService</span> {'{'}{'\n'}
    ...
    {'  '}<span className="t-fn">getById</span>(id: <span className="t-kw">string</span>) {'{'} <span className="t-kw">return</span> db.<span className="t-fn">select</span>().<span className="t-fn">from</span>(<span className="t-cls">users</span>).<span className="t-fn">where</span>(<span className="t-fn">eq</span>(<span className="t-cls">users</span>.id, id)); {'}'}{'\n'}
    ...
    {'  '}<span className="t-fn">update</span>(id: <span className="t-kw">string</span>, data: <span className="t-kw">any</span>) {'{'} <span className="t-kw">return</span> db.<span className="t-fn">update</span>(<span className="t-cls">users</span>).<span className="t-fn">set</span>(data).<span className="t-fn">where</span>(<span className="t-fn">eq</span>(<span className="t-cls">users</span>.id, id)); {'}'}{'\n'}
    {'  '}<span className="t-fn">delete</span>(id: <span className="t-kw">string</span>) {'{'} <span className="t-kw">return</span> db.<span className="t-fn">delete</span>(<span className="t-cls">users</span>).<span className="t-fn">where</span>(<span className="t-fn">eq</span>(<span className="t-cls">users</span>.id, id)); {'}'}{'\n'}
    {'}'}{'\n\n'}
    <span className="t-dec">@Controller</span>(<span className="t-str">'/users'</span>){'\n'}
    <span className="t-dec">@Injectable</span>([<span className="t-cls">UserService</span>]){'\n'}
    <span className="t-kw">class</span> <span className="t-cls">UserController</span> {'{'}{'\n'}
    ...
    {'  '}<span className="t-dec">@Get</span>(<span className="t-str">'/:id'</span>) <span className="t-dec">@Public</span>() <span className="t-fn">get</span>(c: <span className="t-cls">Context</span>) {'{'} <span className="t-kw">return</span> <span className="t-kw">this</span>.service.<span className="t-fn">getById</span>(<span className="t-fn">Param</span>(c, <span className="t-str">'id'</span>)); {'}'}{'\n'}
    {'  '}<span className="t-dec">@Post</span>() <span className="t-kw">async</span> <span className="t-fn">create</span>(c: <span className="t-cls">Context</span>) {'{'}{'\n'}
    {'    '}<span className="t-kw">return</span> <span className="t-kw">this</span>.service.<span className="t-fn">create</span>(<span className="t-kw">await</span> <span className="t-fn">Body</span>(c, <span className="t-cls">CreateUserSchema</span>));{'\n'}
    {'  '}{'}'}{'\n'}
    {'  '}<span className="t-dec">@Patch</span>(<span className="t-str">'/:id'</span>) <span className="t-kw">async</span> <span className="t-fn">update</span>(c: <span className="t-cls">Context</span>) {'{'}{'\n'}
    {'    '}<span className="t-kw">return</span> <span className="t-kw">this</span>.service.<span className="t-fn">update</span>(<span className="t-fn">Param</span>(c, <span className="t-str">'id'</span>), <span className="t-kw">await</span> <span className="t-fn">Body</span>(c));{'\n'}
    {'  '}{'}'}{'\n'}
    {'  '}<span className="t-dec">@Delete</span>(<span className="t-str">'/:id'</span>) <span className="t-fn">remove</span>(c: <span className="t-cls">Context</span>) {'{'} <span className="t-kw">return</span> <span className="t-kw">this</span>.service.<span className="t-fn">delete</span>(<span className="t-fn">Param</span>(c, <span className="t-str">'id'</span>)); {'}'}{'\n'}
    {'}'}{'\n\n'}
    <span className="t-kw">const</span> app = <span className="t-kw">new</span> <span className="t-cls">Hono</span>();{'\n'}
    app.<span className="t-fn">route</span>(<span className="t-str">'/'</span>, <span className="t-cls">HonoRouteBuilder</span>.<span className="t-fn">build</span>(<span className="t-cls">UserController</span>));{'\n'}
    <span className="t-kw">export default</span> app;
      ...
      <div className="code-section reveal">
        ...
        <div>
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <div className="code-step-title">2. No setup needed</div>
            <div className="code-window">
              <div className="code-window-header">
                <span className="dot dot-red" />
                <span className="dot dot-yellow" />
              ...
              <div className="code-body">
                <pre>
                  ...
                  {'    '}<span className="t-str">"target"</span>: <span className="t-str">"ESNext"</span>{'\n'}
                  {'  '}{'}'}{'\n'}
                  {'}'}
                </pre>
              </div>
