const GROUPS = [
  ...
  },
  {
    label: 'interceptors',
    items: [
      { name: '@Retry(opts)',      desc: 'Retries the method on failure. Options: attempts, delay, backoff.' },
      ...
      { name: '@TrackMetrics(opts)', desc: 'Records metrics metadata. Options: name. Integrate with Prometheus or similar.' },
    ],
  },
  {
